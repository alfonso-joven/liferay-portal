...
public class AddEventRepeatingMonthlyDateTest extends BaseTestCase {
	public void testAddEventRepeatingMonthlyDate() throws Exception {
		...
		assertTrue(selenium.isChecked("//input[@id='_8_recurrenceTypeMonthly']"));
		...
		selenium.open(
			"/web/guest/calendar-test-page?p_p_id=8&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_8_tabs1=day&_8_month=2&_8_day=4&_8_year=2010");
		assertTrue(selenium.isElementPresent("link=Calendar Event Title"));
		selenium.open(
			"/web/guest/calendar-test-page?p_p_id=8&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_8_tabs1=day&_8_month=2&_8_day=11&_8_year=2010");
