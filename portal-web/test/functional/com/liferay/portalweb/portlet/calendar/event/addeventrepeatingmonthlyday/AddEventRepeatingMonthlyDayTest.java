...
public class AddEventRepeatingMonthlyDayTest extends BaseTestCase {
	public void testAddEventRepeatingMonthlyDay() throws Exception {
		...
		selenium.open(
			"/web/guest/calendar-test-page?p_p_id=8&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_8_tabs1=day&_8_month=2&_8_day=1&_8_year=2010");
		assertTrue(selenium.isElementPresent("link=Calendar Event Title"));
		selenium.open(
			"/web/guest/calendar-test-page?p_p_id=8&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_8_tabs1=day&_8_month=2&_8_day=8&_8_year=2010");
