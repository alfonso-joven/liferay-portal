...
<div class="lfr-theme-list">
	<div class="float-container lfr-current-theme" id="<%= device %>LookAndFeel">
		...
		<div>
			<img alt="<%= selTheme.getName() %>" class="theme-screenshot" onclick="<portlet:namespace /><%= device %>selectTheme('SelTheme', false);" src="<%= selTheme.getStaticResourcePath() %><%= selTheme.getImagesPath() %>/thumbnail.png" title="<%= selTheme.getName() %>" />
							...
							<aui:fieldset cssCclass="color-schemes">
								<div class="lfr-component lfr-theme-list">
									...
									<div class="<%= cssClass %> theme-entry">
										<img alt="" class="modify-link theme-thumbnail" onclick="<portlet:namespace /><%= device %>selectColorScheme('#<portlet:namespace /><%= device %>ColorSchemeId<%= i %>');" src="<%= selTheme.getStaticResourcePath() %><%= curColorScheme.getColorSchemeThumbnailPath() %>/thumbnail.png" title="<%= curColorScheme.getName() %>" />
					...
					%>
							...
							<li>
								<div class="theme-entry">
									<img alt="" class="modify-link theme-thumbnail" onclick="<portlet:namespace /><%= device %>selectTheme('ThemeId<%= i %>', true);" src="<%= curTheme.getStaticResourcePath() %><%= curTheme.getImagesPath() %>/thumbnail.png" title="<%= curTheme.getName() %>" />
